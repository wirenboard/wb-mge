...
Usage: {script_name} [--keys KEYS_FILE] [--swap_tables SWAP_TABLES_FILE] [--out_header OUT_HEADER_FILE]
...
if len(args.mac):
    ...
    generate_keys_header_file(args.out_header, result_hmac_key, hmac_table, result_swap, swap_table)
