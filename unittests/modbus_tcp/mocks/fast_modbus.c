...
enum fast_modbus_probe_result fast_modbus_send_probe_response(
    uint8_t port, tcp_desc_t *tcp_desc, int client_sock, uint32_t conn_generation, uint8_t *tcp_req_buf)
{
    (void)port; (void)tcp_desc; (void)client_sock; (void)conn_generation; (void)tcp_req_buf;
