...
const uint8_t * favicon_end asm("_binary_favicon_webp_gz_end") = favicon_data + ARRAY_SIZE(favicon_data);

const uint8_t * index_css_start asm("_binary_index_css_gz_start") = css_data;
const uint8_t * index_css_end asm("_binary_index_css_gz_end") = css_data + ARRAY_SIZE(css_data);

const uint8_t * index_js_start asm("_binary_index_js_gz_start") = js_data;
const uint8_t * index_js_end asm("_binary_index_js_gz_end") = js_data + ARRAY_SIZE(js_data);

const uint8_t * index_html_start asm("_binary_index_html_gz_start") = html_data;
const uint8_t * index_html_end asm("_binary_index_html_gz_end") = html_data + ARRAY_SIZE(html_data);
