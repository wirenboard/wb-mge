...
// Тестируем успешную и повторную инициализацию gpio_expander_init
void test_gpio_expander_init_success(void)
{
    LOG_MESSAGE();
    LOG_COLORED_MESSAGE(CONS_COLOR_LIGHT_BLUE, "Test gpio_expander_init and reinit - success cases");
    LOG_MESSAGE();
