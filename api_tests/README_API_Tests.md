...
- По умолчанию WB-MGE создает точку доступа `192.168.42.1`
...
```python
api = WBMGEAPI("http://192.168.42.1")  # Замените на IP вашего устройства
```
...
### 4. Запустить тесты
```bash
# С IP адресом по умолчанию (192.168.42.1)
python test_api.py
