...
static_assert(PROT_CODE_TASK_DELAY_MS_MAX > PROT_CODE_TASK_DELAY_MS_MIN, "PROT_CODE_TASK_DELAY_MS_MAX must be > PROT_CODE_TASK_DELAY_MS_MIN");
static_assert(PORT_EXPANDER_TASK_DELAY_MS_MAX > PORT_EXPANDER_TASK_DELAY_MS_MIN, "PORT_EXPANDER_TASK_DELAY_MS_MAX must be > PORT_EXPANDER_TASK_DELAY_MS_MIN");
static_assert(SYSTEM_MONITOR_TASK_DELAY_MS_MAX > SYSTEM_MONITOR_TASK_DELAY_MS_MIN, "SYSTEM_MONITOR_TASK_DELAY_MS_MAX must be > SYSTEM_MONITOR_TASK_DELAY_MS_MIN");

static_assert(SYSTEM_MONITOR_TASK_DELAY_MS_MIN > PROT_CODE_TASK_DELAY_MS_MAX, "SYSTEM_MONITOR_TASK_DELAY_MS_MIN must be > PROT_CODE_TASK_DELAY_MS_MAX");
static_assert(SYSTEM_MONITOR_TASK_DELAY_MS_MIN > PORT_EXPANDER_TASK_DELAY_MS_MAX, "SYSTEM_MONITOR_TASK_DELAY_MS_MIN must be > PORT_EXPANDER_TASK_DELAY_MS_MAX");
...
void copy_protection_init_keys(void)
{
    ...
    esp_err_t copy_protection_start_protection_code_task(void)
    {
        if (prot_ctx.prot_code_task_handle == NULL) {
            ...
            BaseType_t ret = xTaskCreate(
                protection_code_task, "", PROT_CODE_TASK_STACK_SIZE, NULL, PROT_CODE_TASK_PRIORITY, &prot_ctx.prot_code_task_handle
            );
    ...
    esp_err_t copy_protection_start_port_expander_task(void)
    {
        if (prot_ctx.port_exp_task_handle == NULL) {
            ...
            BaseType_t ret = xTaskCreate(
                port_expander_task, "", PORT_EXPANDER_TASK_STACK_SIZE, NULL, PORT_EXPANDER_TASK_PRIORITY, &prot_ctx.port_exp_task_handle
            );
    ...
    esp_err_t copy_protection_start_sys_monitor_task(void)
    {
        if (prot_ctx.sys_monitor_task_handle == NULL) {
            ...
            BaseType_t ret = xTaskCreate(
                sys_monitor_task, "", SYSTEM_MONITOR_TASK_STACK_SIZE, NULL, SYSTEM_MONITOR_TASK_PRIORITY, &prot_ctx.sys_monitor_task_handle
            );
