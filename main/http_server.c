...
httpd_uri_t index_get = {.uri = "/", .method = HTTP_GET, .handler = index_get_handler, .user_ctx = NULL};
httpd_uri_t uart_settings_get = {.uri = "/uart_settings", .method = HTTP_GET, .handler = uart_settings_get_handler, .user_ctx = NULL};
httpd_uri_t uart_settings_post = {.uri = "/uart_settings", .method = HTTP_POST, .handler = uart_settings_post_handler, .user_ctx = NULL};
