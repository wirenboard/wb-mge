...
<i18n>
{
  "en": {
    ...
    "stale_dot_title": "Value timeout reached",
    "ago": "ago",
    "last": "last",
    "slave_n": "Slave {n}",
    "registers": "registers",
    ...
    "seconds": "seconds",
    "value_timeout_desc": "Once a register's last update reaches this age, the gateway returns Modbus error 0x0B instead of the cached value. Set to 0 to disable the timeout (always serve cached values).",
  ...
  "ru": {
    ...
    "stale_dot_title": "Таймаут значения достигнут",
    "ago": "назад",
    "last": "последний",
    "slave_n": "Slave {n}",
    "registers": "регистры",
    ...
    "seconds": "секунд",
    "value_timeout_desc": "Когда возраст последнего обновления регистра достигает этого значения, шлюз вернёт Modbus 0x0B вместо значения. Установите 0, чтобы отключить (всегда отдавать кэшированные значения).",
    ...
    "listen_port_desc": "Последовательный порт, трафик регистров которого отслеживает кэш.",
  ...
  "kk": {
    ...
    "stale_dot_title": "Мән таймаутына жетті",
    "ago": "бұрын",
    "last": "соңғы",
    "slave_n": "Slave {n}",
    "registers": "тіркеулер",
    ...
    "seconds": "секунд",
    "value_timeout_desc": "Тіркеудің соңғы жаңартуының жасы осы мәнге жеткенде, шлюз кэштелген мән орнына Modbus 0x0B қатесін қайтарады. Таймаутты өшіру үшін 0 орнатыңыз.",
  ...
  "it": {
    ...
    "stale_dot_title": "Timeout valore raggiunto",
    "ago": "fa",
    "last": "ultimo",
    "slave_n": "Slave {n}",
    "registers": "registri",
    ...
    "seconds": "secondi",
    "value_timeout_desc": "Quando l'ultimo aggiornamento di un registro raggiunge questa età, il gateway restituisce l'errore Modbus 0x0B invece del valore in cache. Imposta 0 per disabilitare il timeout.",
  ...
  "de": {
    ...
    "stale_dot_title": "Wert-Timeout erreicht",
    "ago": "her",
    "last": "zuletzt",
    "slave_n": "Slave {n}",
    "registers": "Register",
    ...
    "seconds": "Sekunden",
    "value_timeout_desc": "Sobald das letzte Update eines Registers dieses Alter erreicht, gibt das Gateway den Modbus-Fehler 0x0B zurück. 0 setzen, um das Timeout zu deaktivieren.",
