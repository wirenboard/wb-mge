      ...
      <div class="stack">
        ...
        <section class="card">
          ...
          <div class="card-body">
            ...
            <div class="kv">
              <div class="k">{{ t('heap_info') }}</div>
              <div class="v mono">{{ Math.round(info!.heap_free / 1024) }}({{ Math.round(info!.heap_min_free / 1024) }})/{{ Math.round(info!.heap_total / 1024) }} {{ t('kb') }}</div>
            </div>
...
<i18n>
{
  ...
  "ru": {
    ...
    "heap_info": "Память свободная(мининимум)/всего",
    "kb": "КБ",
    "psram_available": "{kb}",
