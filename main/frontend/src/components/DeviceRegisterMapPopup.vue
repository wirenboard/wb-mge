...
const inputRows: RegRow[] = [
  ...
  { dec: '336', hex: '0x0150', regs: 1, type: 'u16', desc: { en: 'Cache value timeout, seconds', ru: 'Таймаут значения кэша, секунды' } },
...
const notes: BiText[] = [
  ...
  { en: 'Bus statistics (336–342) come from the multimaster cache; with the cache inactive these fields read as 0.', ru: 'Статистика шины (336–342) берётся из мультимастер-кэша; при неактивном кэше соответствующие поля читаются как 0.' },
