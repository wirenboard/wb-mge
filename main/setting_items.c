...
static const setting_item_t setting_items[] = {
    ...
    {KEY_AP_PASS, DEFAULT_AP_PASS, validate_wifi_password, SETTING_ITEM_TYPE_STRING},
    ...
    {KEY_STA_SSID, DEFAULT_STA_SSID, validate_sta_ssid, SETTING_ITEM_TYPE_STRING},
    {KEY_STA_PASS, DEFAULT_STA_PASS, validate_wifi_password, SETTING_ITEM_TYPE_STRING},
